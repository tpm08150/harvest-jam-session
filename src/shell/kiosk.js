...
/* Kiosk — the page with nobody in front of it.
   ...
   this does is ASK without waiting to be told to. On the Pi the answer comes from a Chromium
   policy file rather than from a dialogue nobody can click — see pi/README.md. On a laptop
   with kiosk on you get the ordinary prompts, which is the honest behaviour and makes this
